    ...
    <body>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a href="empleados.jsp">Empleados en General</a></li>
        ...
        <div class="wrap row">
            ...
            <div class="col-xs-12 col-md-4 top_table_title" style="padding-top: 30px;">
                <button style="float: right; margin-left: 5px;" type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#borrarEmpleados">Borrar Tabla</button>
                <button style="float: right;" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEmpleados">Añadir Datos</button>
            </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form class="form-horizontal" action="EmpleadosSVT" method="post">
                        ...
                        <div class="form-group">
                          <label class="col-lg-3 control-label">Seguro Social</label>
                          <div class="col-lg-9">
